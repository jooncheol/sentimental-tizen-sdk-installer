 ...
 * Command line was: qdbusxml2cpp -c PKTransaction -p pktransaction -N org.freedesktop.PackageKit.Transaction.xml
 *
...
#ifndef PKTRANSACTION_H_1329033224
#define PKTRANSACTION_H_1329033224
 ...
 */
class PKTransaction: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    PKTransaction(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
